...
Feature: Basic functionality which check the health of website after every deployment
  ...
  @synchuser @checkoutUsingExistingTradeAccount @live @websmoketest @euapaconly @cicd
  ...
  @checkoutNewTradeAccount @live @websmoketest @cicd
  ...
  @guestcheckoutUsingCC @websmoketest @live @cicd
  ...
  Scenario: Verify the order history for recent orders
    ...
    Then I verify element "OrderTracking.orderStatus&Tracking_text" is present on page and display 'Order Status & Tracking' in report
