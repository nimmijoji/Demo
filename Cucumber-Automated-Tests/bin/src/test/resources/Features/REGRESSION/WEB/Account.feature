...
Feature: Account validations tests
  ...
  Scenario: Form filling: Apply for trade account option from my account drop down
		    ...
		    And I take screenshot of the page
		    And I click on "TradeAccount.submit_button"
  ...
  @ReturnProduct @eu @apac @Priority3 @live
  ...
  @EmailAddFavouriteList @Priority3 @live
  ...
  @EditProfileInformation @Priority3 @live
  Scenario: Edit Profile Information
		    ...
		    And I wait for "2" seconds
		    And I verify text "Your changes have been saved." in page "MyAccountProfileInformation.successMessage_text"
		    #------- Add Address  -------#
		    And I click Address link on Account page "MyAccount.addresses_link"
		    And I wait for "4" seconds
		    And I verify text "Add Address" in page "MyAccountAddress.addAddress_text"
		    ...
		    And I wait for "4" seconds
		    And I verify the message that contains "was successfully added." in Address page "MyAccountAddress.addressUpdateSave_text"
		    ...
		    And I wait for "2" seconds
		    And I verify the message that contains "was successfully updated." in Address page "MyAccountAddress.addressUpdateSave_text"
		    #-----  Delete Address ------#
		    And I click on "MyAccountAddress.deleteAddress_button"
		    And I wait for "2" seconds
		    And I click on "MyAccountAddress.confirmDelete_button"
		    And I verify the message that contains "was successfully deleted." in Address page "MyAccountAddress.addressUpdateSave_text"
  ...
  @CSVExportForOrderSummary @Priority3
