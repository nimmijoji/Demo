...
Feature: Search priority 3 validation tests
      ...
      @leadTimeDispaly @AddToBasketUsingLHSNav @Priority3 @live
      ...
      @FindSimilarProducts  @Priority3 @live
      ...
      @ChangingPerPageProductsAndPaginationOnPLP @Priority3 @live
 ...
 @SpecialCharSearch @Priority3 @Search @live
