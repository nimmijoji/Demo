...
Feature: Search priority 2 validation tests
  ...
  @viewROHSCertificateRegression @Priority2 @live
  Scenario: Search - View ROHS certificate and displays users name
		    ...
		    And I click Show all Products button on L0 category page "CategoryPage.showAllProducts_button" using js
  ...
  @MPNSearch @Priority2 @Search @live
  ...
  @DescriptiveSearch @Priority2 @Search @live
  ...
  @ManufacturerSearch @Priority2 @Search @live
  ...
  @StemmingSearch @Search @Priority2 @live
  ...
  @QuickOrder @Priority2 @Search @live
  ...
  @QuickPaste @Priority2 @Search @live
  ...
  @CompareProducts @Priority2 @live
  Scenario: Compare Products
      ...
      @NullResultPage @Priority2 @aditya
      Scenario Outline: Search Null Result Page
            Given web site is launched successfully and user "does" accept the cookies
