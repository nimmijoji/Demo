@WebRegression @checkout @10
Feature: Checkout validation tests

  @ExpressCheckout @Priority1 @live
  ...
  @PlaceAnOrderWithAccount @Priority1
  ...
  @RegistrationPromptAfterGuestCheckout @Priority1
  Scenario: Checkout - Registration prompt after guest checkout
		    ...
		    And I click on Create Account button on Order Confirmation page  "Checkout.createAccount_button"
		    And I wait for "2" seconds
  ...
  @PaypalPaymentCheckout @Priority2 @eu @live
  ...
  @ChangePaymentMethod @Priority2 @live
  Scenario: Checkout - Change payment method test
		    Given web site is launched successfully and user "does" accept the cookies
		    When customer accesses the website as "register" user
		    Then User navigate to "c/crystals-oscillators/crystals" page
		    And I wait for "3" seconds
  ...
  @SchedulingOrderRegression @Priority1 @live
  ...
  Scenario: Change the Delivery method and verify charges
		    ...
		    And I select no "4" radio button as Shipping method option on Shipping/Delivery methods section and display its name in report
  ...
  @LinenoteShareOrder @ft @Priority3
  Scenario: Enter the Partno and Line note while placing an order and then share the order
        #----- Registration Steps ----#
				...
				When I navigate to "/through-hole-resistors" page
				And I wait for "3" seconds
				...
				And I scroll till "ShoppingCart.checkoutNow_button"
				Then I click on the "ShoppingCart.checkoutNow_button"
				And I wait for "5" seconds
				And I click on Continue button on Invoice addressSection "Checkout.paymentdetailContinue_button" using js
				And I wait for "3" seconds
				#----- User enters Address details ----#
				And User fill Checkout Invoice address by entering four characters in auto Search textbox "Calle"
				And I scroll till "Checkout.invoiceDeliveryAddressContinue_button"
				And I click on Continue button on Delivery Section "Checkout.invoiceDeliveryAddressContinue_button" using js
				And I wait for "5" seconds
				And I scroll till "Checkout.deliverySectionContinue_button"
				...
				And user take screenshot of the page
				Then I click My Account dropdown "Header.myAccount_dropdown"
				And I wait for "2" seconds
