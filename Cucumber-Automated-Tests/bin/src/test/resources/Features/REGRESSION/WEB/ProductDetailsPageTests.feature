...
Feature:  Product details page(PDP) checks for different products
    ...
    Scenario: Verify Product information, Product overview, technical docs and Legislation & Environmental sections for instock product
        ...
        And I verify Technical Docs section header contains "Technical Docs" in page "PDP.technicalDocument_text"
    ...
    @pdpregression @pdpaltsection @WebRegression @live
    ...
    @pdpregression @pdpassociatedsection @WebRegression @live
    Scenario: Verify associated products section on PDP for instock product
        Given I enter "instock" ordercode from file "PDPRegressionOrderCodes.xlsx" in searchbox
        When I click the "Header.searchIcon_button"
        Then I scroll down the page by pixels "2000"
    ...
    @pdpregression @avnetcontainer
    Scenario: Verify avnet container product
        Given I enter "avnetcontainerproduct" ordercode from file "PDPRegressionOrderCodes.xlsx" in searchbox
        When I click the "Header.searchIcon_button"
    ...
    @pdpregression @avnetpopup
    Scenario: Verify avnet pop up product
        Given I enter "avnetpopupproduct" ordercode from file "PDPRegressionOrderCodes.xlsx" in searchbox
        When I click the "Header.searchIcon_button"
    ...
    Scenario: Verify product 360 Image on PDP
        ...
        And I take screenshot
        And I verify element "PDP.product360ImageContainer_element" is present on page

    @pdpregression @ukonly
    Scenario: Verify additional packaging product PDP for uk
        ...
        Then I verify text "Reel" in page "PDPBuyBox.packagingTypeValue_text"
