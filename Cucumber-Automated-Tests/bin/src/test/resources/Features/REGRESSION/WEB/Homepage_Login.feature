...
Feature: Homepage and login validation tests
  ...
  Scenario: Forgot password
		    ...
		    And I click on forgot password link on login page "Login.forgotPassword_link"
		    ...
		    And I verify the message that contains "Reset email sent" in page "ForgotPassword.resetEmailSent_text"
		    And I take screenshot of page

  @ShowPagesForTabs @Priority3 @live
  Scenario: Homepage - View Pages for tabs on Home page
		    ...
		    And I wait for "3" seconds
		    Then I hover on element "Home.resource_link"
		    And I wait for "3" seconds
		    ...
		    Then I take screenshot
		    And I click "Home.resource_link"
		    And I wait for "3" seconds
  ...
  Scenario: Forgotten Username - Successful Request test
		    ...
		    And I click on Forgotten Username link "Login.forgotUsername_link"
  ...
  @NavigateToCommunitySiteTest @Priority3 @live
  Scenario: Navigate to community site
		    Given web site is launched successfully and user "does" accept the cookies
		    When customer accesses the website as "guest" user
		    And I wait for "5" seconds
		    And I click on element "Home.community_tab"
