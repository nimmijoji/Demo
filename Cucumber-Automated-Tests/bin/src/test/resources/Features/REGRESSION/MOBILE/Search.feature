...
Feature: Search Pages
  ...
  Scenario Outline: L0 and L1 Category Search
    ...
    Then user verify element "CategoryPage.section_category" is present on page
  ...
  Scenario Outline: Manufacturer Keyword Search
