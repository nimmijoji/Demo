...
Feature: Category page regression
  ...
  #<---------------------------------->
  @multiCategoryPage @mob_reg
  Scenario: Validate the multi-category page navigating via search keyword
    ...
    And I verify text of Category First Paragraph in page "CategoryPage.categoryFirstParagraph_text" from file "Mobile_TextVerification"
    ...
    And I verify text of 'Result Found For Resistor' in page "MultiCategoryPage.resultFoundFor_text" from file "Mobile_TextVerification"
    ...
    And I verify text of 'Result Found For Resistor Chip' in page "MultiCategoryPage.resultFoundForSearchWithin_text" from file "Mobile_TextVerification"
    And I take screenshot to view the shortlisted categories
    And I verify Multi-Categories for element "MultiCategoryPage.multiCategories_section" is present on page
    And I verify text of "Show All Products" in page "MultiCategoryPage.onlyAtBottomShowAllProducts_button"
    #<-----Ui Verification Step--------->
    And I verify text color of 'Show All Products' as "White,#ffffff,MultiCategoryPage.onlyAtBottomShowAllProducts_button"
    And I verify text of 'Show All Products' is Bold "MultiCategoryPage.onlyAtBottomShowAllProducts_button"
    And I verify background color of 'Show All Products' as "Green,#41c363,MultiCategoryPage.onlyAtBottomShowAllProducts_button"
    #<---------------------------------->
    And I click "MultiCategoryPage.onlyAtBottomShowAllProducts_button"
    And I take screenshot to see Category page is displayed with all categories
    Then I verify Category Page element "CategoryPage.section_category" is present on page

  @plpCategorySectionLink @mob_reg
  Scenario: Naviagte to PLP using the subcategory links in categories section
    When I navigate to "c/passive-components/resistors-fixed-value" page
