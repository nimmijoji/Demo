...
@mobile @regression @loginpage
Feature: this feature will test the login functionality for all the stores end to end with UI and error validations
  ...
  Scenario: Validate the UI text and fields for Login page with valid credentials
    ...
    And user verify text of "You have already registered message" in page "Login.section_text" from file "Mobile_TextVerification"
    ...
    And user verify text "> Contact Us" in page "ContactUs.breadcrumbContactUs_text"
    And user verify text "Contact Us" in page "ContactUs.contctUsHeading_text"
    Then customer accesses the website as "login" user

  @login @errorValidation @reg
  Scenario Outline: Validate the error message for login page
    ...
    And user verify text color of 'error message' heading as "Red,#d9534f,Login.topHeaderError_text"
    And user verify text of 'error message' heading is Bold "Login.topHeaderError_text"
    And user verify text of "Either the username or password is incorrect. Please check and re-enter the information again." in page "Login.invalidUsernameOrPassword_text"
	...
	@changePwd @registeredUser @priority4 @reg
  ...
  @fusername @singleuser @multiuser @functionalValidation @soumen
  Scenario Outline: To validate the functionality of forgot your username on PF website for single/multi user
    ...
    Examples: 
      | email                 |
      | pf_testuser@yahoo.com |

  @fusername @singleuser @multiuser @UiValidation @soumen
  ...
  @fusername @singleuser @multiuser @errorValidation @soumen1
  Scenario Outline: To validate error functionality of forgot your username on PF website for single/multi user
    ...
    #And user verify text color of 'required field message' heading as "Red,#d9534f,ForgotYourUsername.requiredFieldsMessage_text"
    ...
    @fpwd @singleuser @functionalValidation @regfpwd @soumen1
  ...
  @fpwd @multiuser @functionalValidation @regfpwd @soumen1
  ...
  @fpwd @multiuser @UiValidation @soumen1
  Scenario: To validate the UI Validation & functionality of forgot your password on PF website for single/multi user
    Given web site is launched successfully and user "does" accept the cookies
    And customer accesses the website as "Guest" user
    Then user click on "Header.login_link"
    When user click on "Login.forgotYourPassword_link"
    And user take screenshot of the enter details page for forgot password
    And user verify text of "Forgot your password" in page "ForgotPassword.forgottenYourPassword_text"
    ...
    And user click on "ForgotPassword.continue_button"
    And user verify text of "Forgot your password" in page "ForgotPassword.forgottenYourPassword_text"
    Then user verify text of "Reset email sent" in page "ForgotPassword.resetEmailSent_text"
    And user verify text color of 'Reset email sent' heading as "Green,#3a9c54,ForgotPassword.resetEmailSent_text"
    And user verify text of "Farnell has sent an email with a link to reset your password to:" in page "ForgotPassword.emailDescriptionOne_element"
    And user verify element "ForgotPassword.userEmailID_text" is present on page and display 'user email address' in report
    And user verify text of "Did not receive the email? Please check that you have a Farnell account, the spelling of the email address and your spam folder." in page "ForgotPassword.emailDescriptionTwo_element"
    And user take screenshot of the success forgot password page

  @fpwd @multiuser @errorValidation @soumen1
  Scenario Outline: To validate error functionality of forgot your password on PF website for single/multi user
    ...
    Examples: 
      ...
      | pf_test      | test            |pf_testuser@yahoo.com|