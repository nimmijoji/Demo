...
public class Home_Objs {
    ...
    static {
        ...
        Home.put(
            ...
            "//*[@class='panel panel-default small-margin border-sm']/div[2]/div[contains(@class,'manf-logo')]/a[1]"
        );

        Home.put("services_list", "//*[@class='mb-fstack']/a");
        ...
        Home.put(
            "termsOfuse_link",
            "//*[@id='ad_pf_footer_espot_01']/div/div[2]/ul[2]/li[3]/span/a"
        );
        Home.put(
        ...
        Home.put(
            ...
            "(//*[@class ='mb-flink mb-fleft mb-fclear'])[1]"
        );
        Home.put("shoppingCart_link", "(//*[@class ='mb-flink mb-fleft'])[1]");
        Home.put(
            "myFooterAccount_link",
            "(//*[@class ='mb-flink mb-fleft mb-fclear'])[2]"
        );
        Home.put(
            "orderHistoryAndTracking_link",
            "(//*[@class ='mb-flink mb-fleft mb-fclear'])[3]"
        );
        Home.put(
            "calculatorsAndCharts_link",
            "(//*[@class ='mb-flink mb-fleft mb-fclear'])[4]"
        );
        Home.put(
            "viewAllManufacturers_link",
            "(//*[@class ='mb-flink mb-fleft mb-fclear'])[5]"
        );
        Home.put(
            "engineeringGlossary_link",
            "(//*[@class ='mb-flink mb-fleft mb-fclear'])[6]"
        );
        Home.put("contactUs_link", "(//*[@class ='mb-flink mb-fleft mb-fclear'])[7]");
        Home.put("aboutUs_link", "(//*[@class ='mb-flink mb-fleft mb-fclear'])[8]");
    }
