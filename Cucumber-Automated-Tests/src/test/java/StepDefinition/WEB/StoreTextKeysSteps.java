...
public class StoreTextKeysSteps extends WebDriverConfig {
    ...
    public void saveStoreKeys(String fileName)
        ...
        reader.close();
        try {
            storeTextFile = new FileWriter(storeTextfileName);
    ...
    public void saveHTMLInnerText(String fileName) throws CsvValidationException {
        ...
        FileWriter innerTextFile_temp = null;
        ...
        try {
            innerTextFile_temp = new FileWriter(storeTextfileNameTemp);
        ...
        try {
            innerTextFile = new FileWriter(storeTextfileName);
    ...
    public void saveHTMLSourceCode(String fileName) throws CsvValidationException {
        FileWriter htmlSourceCode = null;
        ...
        try {
            htmlSourceCode = new FileWriter(storeTextfileName);
    ...
    public void register_user_storetext(String user) throws Throwable {
        ...
        actionMethods.navigateToPage(actionMethods.getSiteBaseUrl() + "/" + "register");
