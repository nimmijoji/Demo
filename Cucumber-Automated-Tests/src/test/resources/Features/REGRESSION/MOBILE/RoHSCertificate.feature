...
Feature: Verify RoHS Certificate
  ...
  @nameAndImgAccordian @eu @apac @nwk @live
  ...
  @PriceAccordian @eu @apac @nwk @live
  ...
  @AvailabilityAccordian @eu @apac @nwk @live
  ...
  @ProductInfoAccordian @eu @apac @nwk @live
  ...
  @ProductOverviewAccordian @eu @apac @nwk @live
