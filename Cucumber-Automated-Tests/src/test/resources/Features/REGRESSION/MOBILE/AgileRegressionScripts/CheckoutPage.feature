...
@checkout @mobAgileRegression
Feature: Basic Checkout functionality with different payment option

  Background: Launch homepage for PDP regression check
    Given web site is launched successfully and user "does" accept the cookies

  @VoucherCode @editPaymentToTradeFromCC @Priority2 @eu @apac @nwk
  Scenario: Verify user able to apply voucher code successfully and place order using credit card 
  					and user is also able to edit the payment mwthod from Credit Card to Trade account
    ...
    And I enter voucher code value "UKFT5" in textbox "ShoppingCart.voucherCode_textBox"
    And I click on "ShoppingCart.voucherCodeApply_button"
    And I wait for "3" seconds
    Then user verify text "Voucher Discount" is visible for "ShoppingCart.voucherCode_text"
    And User take screenshot of the page
    And user verify text "UKFT5" is visible for "ShoppingCart.voucherName_text"
    ...
    And User take screenshot of the page
    And I enter PO number value "VoucherApplied" in textbox "Checkout.poNumber_textbox"
    ...
    When I click on "Checkout.editInvoiceAddress_button"
