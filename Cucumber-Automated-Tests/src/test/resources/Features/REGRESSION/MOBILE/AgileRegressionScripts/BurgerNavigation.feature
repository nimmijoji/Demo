#Author: Raji Kambar
@BurgerNavigation @mobAgileRegression
Feature: Burger Navigation Regression
  ...
  Scenario: I want to verify Manufactureres on  Burger Navigation
    ...
    And user click on  category link "BurgerNavigation.manufacturer_element"
  ...
  Scenario: I want to verify Resources on  Burger Navigation
    ...
    And I verify backArrow header element "BurgerNavigation.resourcesMenuBack_button" is present on page
    And user verify text "Back to Main Menu" is visible for "BurgerNavigation.resourcesPanelTitle_element"
    And verify values in the "BurgerNavigation.resourcesMenu_list" table are not empty
    And user display the level1 categories list "BurgerNavigation.resourcesMenu_list" in the report
    #<-----Ui Verification Step--------->
    And I verify text color of 'Back to Main Menu' as "White,#ffffff,BurgerNavigation.resourcesPanelTitle_element"
    And I verify text of 'Back to Main Menu' is Bold "BurgerNavigation.resourcesPanelTitle_element"
    And I verify background color of 'Back to Main Menu' as "Green,#41c363,BurgerNavigation.resourcesPanelTitleBckGrnd_element"
    And user click on backleftArrow on resources  "BurgerNavigation.resourcesMenuBack_button"
    And I wait for "3" seconds
    And user click on backleftArrow on resources  "BurgerNavigation.backLeftArrowLevel1_button"
  ...
  @AllBurgerNavigation @eu @apac @live
