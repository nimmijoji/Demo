#Author: saseelam@in.ibm.com
@mobAgileRegression
Feature: Succesful Registration of user using mobile

  @mobRegistration @ui @eu @apac @nwk
  Scenario: Features of Mobile Registration form
    ...
    And user verify text "Username and Password" in page "Register.usrnameAndPwdTitle_text"
    And user verify text "*Username" in page "Register.usrname_label"
    ...
    And user verify background color of 'Register button' as "Green,#41c363,Register.register_button"
 		...
 		@invalidPwd @errorValidation @eu @apac @nwk
    ...
    @invalidDetails @errorValidation @eu @apac @nwk
    Scenario: Error message when Username,Password and Email are Invalid
       Given web site is launched successfully and user "does" accept the cookies
       When user click on the register link "Register.register_link"
       And user click "Register.registerNow_button"
       And user wait for "3" seconds
       ...
       And user verify text color of the error message heading as "Red,#d9534f,Register.singleErrMessageHeading_text"
       And user verify text of 'Please correct the following fields:' is Bold "Register.singleErrMessageHeading_text"
       And user verify if the invalid input fields "username#password#email" are displayed in the error message "Register.errInputFieldsInSingleError_list"
       And user verify color of elements text in "Register.errInputFieldsInSingleError_list" list as "Red,#d9534f"
       And user verify color of elements text in "Register.passwordValidation_list" list as "Red,#ff0000&&#007f3b"
       And user take screenshot of the error message displayed on page  
             
      @blankInput @errorValidation @eu @apac @nwk
      Scenario: Error Message when only partial input fields are blank 
          ...
          And user verifies if "username#password#email#primaryjob#firstname#title" input fields displayed on blank error message "Register.errInputFieldsInSingleError_list" when user enters data from "MobileRegistrationRegression.xlsx" file
          And user verify color of elements text in "Register.errInputFieldsInSingleError_list" list as "Red,#d9534f"
          And user verify color of elements text in "Register.passwordValidation_list" list as "Red,#ff0000"
          And user take screenshot of the error message displayed on page 
          
      @existingUname @errorValidation @eu @apac @nwk
      Scenario: Registration with existing username
       ...
       @blankPwd @errorValidation @eu @apac @nwk 
       ...
       @blankCreds @errorValidation @eu @apac @nwk
       Scenario: Error message when Username and Password are blank
          ...
          And user verify text color of the error message heading as "Red,#d9534f,Register.singleErrMessageHeading_text"
          And user verify text of 'Please enter all required information' is Bold "Register.singleErrMessageHeading_text"
          And user verifies if "username#password" input fields displayed on blank error message "Register.errInputFieldsInSingleError_list" when user enters data from "MobileRegistrationRegression.xlsx" file
          And user verify color of elements text in "Register.errInputFieldsInSingleError_list" list as "Red,#d9534f"
         And user verify color of elements text in "Register.passwordValidation_list" list as "Red,#ff0000"
          And user take screenshot of the error message displayed on page
          
       @blankData @errorValidation @eu @apac @nwk
       Scenario: Error message when customer data entered is both blank and invalid
          ...
          And user verifies if "username#lastname#primaryuse" input fields displayed on blank error message "Register.blankInputFieldLabelsInMulErrors_list" when user enters data from "MobileRegistrationRegression.xlsx" file
