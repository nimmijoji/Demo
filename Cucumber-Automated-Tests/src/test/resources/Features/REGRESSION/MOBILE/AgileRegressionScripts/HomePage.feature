...
Feature: Home page functionality check
  ...
  Scenario: I want to verify Header on HomePage header section
    ...
    When user click on registernow button "Login.register_now_buuton"
    Then I wait for "6" seconds
    ...
    And I wait for "3" seconds
    #Navigation bar
    And I verify element "Home.navbarToggle_button" is present on page
  ...
  @HomePage @Footer @eu @apac @nwk @live
