...
@mobAgileRegression @checkout
Feature: Different functionalities in shopping cart page for both Registered and guest user

  Background: Launch homepage for Shopping cart regression check
    Given web site is launched successfully and user "does" accept the cookies
    
  @emailBasket @Priority3 @eu @apac @nwk
  Scenario: Verify user able to Email his/her shopping cart
	...
	@shoppingCart @errorValidation @eu @nwk @Priority2 @live
	...
	@shoppingCart @errorValidation @apac @Priority2 @live
