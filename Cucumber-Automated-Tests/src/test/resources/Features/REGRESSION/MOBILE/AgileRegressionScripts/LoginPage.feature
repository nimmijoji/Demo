...
Feature: this feature will test the login functionality for all the stores end to end with UI and error validations
  ...
  Scenario Outline: Validate the error message for login page
	...
	@changePwd @registeredUser @priority4 @eu @apac @nwk
  ...
  @fusername @singleuser @multiuser @functionalValidation @eu @apac @nwk
  ...
  @fusername @singleuser @multiuser @UiValidation @eu @apac @nwk
  ...
  @fusername @singleuser @multiuser @errorValidation @eu @apac @nwk
  Scenario Outline: To validate error functionality of forgot your username on PF website for single/multi user
    ...
    @fpwd @singleuser @functionalValidation @regfpwd @eu @apac @nwk
  ...
  @fpwd @multiuser @UiValidation @eu @apac @nwk
  ...
  @fpwd @multiuser @errorValidation @eu @apac @nwk
