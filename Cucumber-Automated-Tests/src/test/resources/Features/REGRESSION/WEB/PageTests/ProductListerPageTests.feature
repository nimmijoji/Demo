...
Feature: PLP tests
  ...
  @PLP @Priority1 @Pankaj @eu @apac @nwk
  Scenario: Verify PLP Page
    When User navigate to "c/crystals-oscillators/crystals" page
    ...
    And User click Show Results button "CategoryPage.showAllProducts_button" using js
    Then User verify element "PLP.PLP_element" is present on page

  @SearchCompareProductsPLP @Priority2 @Shilpa @eu @apac @nwk
